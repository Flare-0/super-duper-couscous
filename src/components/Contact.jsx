...
export default function Contact() {
  return (
    <section id="contact" className="border-b border-[var(--border-color)]">
      <div className="px-4 md:px-8 py-16 md:py-28">
        <div className="max-w-lg text-left">
          ...
          <a
            ...
            className="inline-flex items-center gap-3 px-8 py-4 md:px-10 md:py-5 border border-[var(--border-color)] hover:border-[var(--border-light)] transition-colors text-base md:text-lg"
          >
